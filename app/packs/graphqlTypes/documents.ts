...
/** Autogenerated input type of FavoriteOceanMarketMutation */
export type FavoriteOceanMarketMutationInput = {
  oceanMarketId: Scalars['ID'];
  /** A unique identifier for the client performing the mutation. */
  clientMutationId?: Maybe<Scalars['String']>;
};
...
export type Mutation = {
  ...
  favoriteOceanMarket?: Maybe<OceanMarket>;
  switchLocale?: Maybe<Scalars['Boolean']>;
  unfavoriteOceanMarket?: Maybe<OceanMarket>;
};
...
export type MutationFavoriteOceanMarketArgs = {
  input: FavoriteOceanMarketMutationInput;
};
...
export type MutationUnfavoriteOceanMarketArgs = {
  input: UnfavoriteOceanMarketMutationInput;
};
...
/** Autogenerated input type of UnfavoriteOceanMarketMutation */
export type UnfavoriteOceanMarketMutationInput = {
  oceanMarketId: Scalars['ID'];
  /** A unique identifier for the client performing the mutation. */
  clientMutationId?: Maybe<Scalars['String']>;
};
...
export type FavoriteOceanMarketMutationVariables = Exact<{
  input: FavoriteOceanMarketMutationInput;
}>;


export type FavoriteOceanMarketMutation = (
  { __typename?: 'Mutation' }
  & { favoriteOceanMarket?: Maybe<(
    { __typename?: 'OceanMarket' }
    & Pick<OceanMarket, 'id' | 'favorited'>
  )> }
);
...
export type UnfavoriteOceanMarketMutationVariables = Exact<{
  input: UnfavoriteOceanMarketMutationInput;
}>;


export type UnfavoriteOceanMarketMutation = (
  { __typename?: 'Mutation' }
  & { unfavoriteOceanMarket?: Maybe<(
    { __typename?: 'OceanMarket' }
    & Pick<OceanMarket, 'id' | 'favorited'>
  )> }
);
...
export type OceanMarketQuery = (
  ...
  & { oceanMarket: (
    { __typename?: 'OceanMarket' }
    & Pick<OceanMarket, 'id' | 'favorited' | 'marketId'>
    & { baseAsset: (
      { __typename?: 'MixinAsset' }
...
export const FavoriteOceanMarketDocument = gql`
    mutation FavoriteOceanMarket($input: FavoriteOceanMarketMutationInput!) {
  favoriteOceanMarket(input: $input) {
    id
    favorited
  }
}
    `;
export type FavoriteOceanMarketMutationFn = Apollo.MutationFunction<FavoriteOceanMarketMutation, FavoriteOceanMarketMutationVariables>;

/**
 * __useFavoriteOceanMarketMutation__
 *
 * To run a mutation, you first call `useFavoriteOceanMarketMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useFavoriteOceanMarketMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [favoriteOceanMarketMutation, { data, loading, error }] = useFavoriteOceanMarketMutation({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useFavoriteOceanMarketMutation(baseOptions?: Apollo.MutationHookOptions<FavoriteOceanMarketMutation, FavoriteOceanMarketMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<FavoriteOceanMarketMutation, FavoriteOceanMarketMutationVariables>(FavoriteOceanMarketDocument, options);
      }
export type FavoriteOceanMarketMutationHookResult = ReturnType<typeof useFavoriteOceanMarketMutation>;
export type FavoriteOceanMarketMutationResult = Apollo.MutationResult<FavoriteOceanMarketMutation>;
export type FavoriteOceanMarketMutationOptions = Apollo.BaseMutationOptions<FavoriteOceanMarketMutation, FavoriteOceanMarketMutationVariables>;
...
export const UnfavoriteOceanMarketDocument = gql`
    mutation UnfavoriteOceanMarket($input: UnfavoriteOceanMarketMutationInput!) {
  unfavoriteOceanMarket(input: $input) {
    id
    favorited
  }
}
    `;
export type UnfavoriteOceanMarketMutationFn = Apollo.MutationFunction<UnfavoriteOceanMarketMutation, UnfavoriteOceanMarketMutationVariables>;

/**
 * __useUnfavoriteOceanMarketMutation__
 *
 * To run a mutation, you first call `useUnfavoriteOceanMarketMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useUnfavoriteOceanMarketMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [unfavoriteOceanMarketMutation, { data, loading, error }] = useUnfavoriteOceanMarketMutation({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useUnfavoriteOceanMarketMutation(baseOptions?: Apollo.MutationHookOptions<UnfavoriteOceanMarketMutation, UnfavoriteOceanMarketMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<UnfavoriteOceanMarketMutation, UnfavoriteOceanMarketMutationVariables>(UnfavoriteOceanMarketDocument, options);
      }
export type UnfavoriteOceanMarketMutationHookResult = ReturnType<typeof useUnfavoriteOceanMarketMutation>;
export type UnfavoriteOceanMarketMutationResult = Apollo.MutationResult<UnfavoriteOceanMarketMutation>;
export type UnfavoriteOceanMarketMutationOptions = Apollo.BaseMutationOptions<UnfavoriteOceanMarketMutation, UnfavoriteOceanMarketMutationVariables>;
