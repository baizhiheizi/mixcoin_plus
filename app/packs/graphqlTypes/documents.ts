...
export type AppletPandoLeafTrigger = {
  __typename?: 'AppletPandoLeafTrigger';
  applet: Applet;
  asset?: Maybe<MixinAsset>;
  createdAt: Scalars['ISO8601DateTime'];
  id: Scalars['ID'];
  params: AppletPandoLeafTriggerParams;
  type: Scalars['String'];
  updatedAt?: Maybe<Scalars['ISO8601DateTime']>;
};

export type AppletPandoLeafTriggerParams = {
  __typename?: 'AppletPandoLeafTriggerParams';
  applet: Applet;
...
export type AppletTriggerUnion = Applet4swapTrigger | AppletDatetimeTrigger | AppletPandoLeafTrigger;
