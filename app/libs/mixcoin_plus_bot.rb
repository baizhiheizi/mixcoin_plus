  ...
  def self.app_statistic
    {
      ...
      applet_activity_swap_orders_traded_total_usd: AppletActivitySwapOrder.traded.sum(:pay_amount_usd),
  ...
  def self.app_statistic_24h
    {
      ...
      applet_activity_swap_orders_traded_total_usd: AppletActivitySwapOrder.within_24h.traded.sum(:pay_amount_usd),
